    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      ...
      <section className="overflow-hidden rounded-[2rem] border border-neutral-200 bg-gradient-to-br from-emerald-900 via-green-800 to-lime-700 px-8 py-16 text-white shadow-lg md:px-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-8 text-neutral-100">
            Illustrated clicker game designed in Illustrator and implemented in
            Adobe Animate, with a playful ranch-themed visual identity.
          </p>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2" id="about">
        <article className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
          ...
          <p className="leading-7 text-neutral-600">
            ...
            project combines asset design with interactive implementation.
          </p>
        ...
        <article className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
          ...
          <ul className="list-disc space-y-2 pl-5 leading-7 text-neutral-600">
            ...
            <li>Interactive clicker implementation.</li>
      ...
      >
        <div className="mb-5">
          ...
          <p className="mt-3 max-w-3xl leading-7 text-neutral-600">
            A quick look at the project’s interaction, visual rhythm, and tile
            style in motion.
          </p>
        </div>
      ...
      >
        <div className="mb-6">
          ...
          <p className="mt-3 max-w-3xl leading-7 text-neutral-600">
            A collection of illustrated tiles used to build the project’s ranch
            world, from natural scenery to structures and supporting elements.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
          {tiles.map((tile) => (
            <article
              key={tile.src}
              className="rounded-3xl border border-neutral-200 bg-neutral-50 p-4 shadow-sm transition hover:-translate-y-1 hover:bg-white hover:shadow-md"
            >
